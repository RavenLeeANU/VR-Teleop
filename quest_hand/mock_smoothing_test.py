...
Examples:
    python -m quest_hand.mock_smoothing_test --no-show
    python -m quest_hand.mock_smoothing_test --postprocess-config quest_hand/postprocess_config.yaml --no-show
    python -m quest_hand.mock_smoothing_test --alpha 0.35 --max-pos-velocity 0.12 --save records/tuned_mock_smoothing.png
"""
