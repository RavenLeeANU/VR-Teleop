...
Examples:
    python -m teleop_vr.smooth_trajectory_experiment records/test02_vr_raw.csv --save records/test02_raw_smooth.png --no-show
    python -m teleop_vr.smooth_trajectory_experiment records/test02_converted.csv --source converted --alpha 0.3 --max-pos-velocity 0.05
"""
